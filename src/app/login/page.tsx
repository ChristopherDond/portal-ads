...
import { Github, AlertCircle, KeyRound, ArrowRight, Loader2 } from "lucide-react";
import { useState, useEffect } from "react";

type Step = "checking" | "code" | "oauth";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    fetch("/api/auth/verify-code")
      .then((r) => r.json())
      .then((data) => setStep(data.verified ? "oauth" : "code"))
      .catch(() => setStep("code"));
  }, []);

  async function handleCodeSubmit() {
    if (!code.trim()) {
      setCodeError("Digite o código de acesso.");
      return;
    }
    setCodeError("");
    setCodeLoading(true);
  ...
  async function handleGithub() {
    ...
    try {
      ...
      setOauthError("Erro ao entrar com GitHub. Tente novamente.");
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      setOauthError("Erro ao entrar com Google. Tente novamente.");
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 bg-zinc-800 border border-zinc-700 rounded-full">
              ...
              <p className="text-zinc-500 text-sm">
                {step === "code"
                  ? "Insira o código de acesso da turma"
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl
                               text-white text-sm font-mono tracking-widest placeholder-zinc-500
            ...
            {step === "oauth" && (
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full text-center text-zinc-600 hover:text-zinc-400 text-xs transition-colors pt-1"
                >
                  Usar outro código
                </button>
              </div>
